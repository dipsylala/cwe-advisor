...
```javascript
// SAFE: async-mutex serializes the read-modify-write across concurrent async calls
...
// SAFE: conditional atomic UPDATE avoids the race entirely at the database
async function withdrawInDb(pool, accountId, amount) {
