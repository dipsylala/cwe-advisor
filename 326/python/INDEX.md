...
- Generate keys with `AESGCM.generate_key(bit_length=256)`, `Fernet.generate_key()`, or `os.urandom(32)` for 256-bit strength, and a fresh `os.urandom(12)` nonce per `AESGCM.encrypt()` call
