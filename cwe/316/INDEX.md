...
Be honest about what clearing buys: a moving collector (JVM, CLR, V8) relocates live objects, so one logical secret exists at addresses the program never held a reference to, and zeroing the array you can reach does nothing about those. The persistent-medium counterparts are CWE-312 and CWE-313.
