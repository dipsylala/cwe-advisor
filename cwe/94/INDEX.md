...
- Test - re-run the input that executed before the fix and confirm it is now refused rather than merely failing differently, and that a legitimate value still evaluates; a sandboxed evaluator that returns null on denial passes a throws-assertion whether or not it was configured
