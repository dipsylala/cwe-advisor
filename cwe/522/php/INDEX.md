...
- Replace direct hash comparison with `password_verify($plaintext, $storedHash)`, and rehash on successful login when `password_needs_rehash()` reports the algorithm or cost has changed
