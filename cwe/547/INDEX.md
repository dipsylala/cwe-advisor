...
The failure mode is a policy change applied *partially*: a timeout restated in three places means shortening it requires finding all three, and nothing fails if you find two. Where the constant is an authentication secret rather than a parameter, the finding is CWE-798.
