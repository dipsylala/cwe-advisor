...
MITRE classes this as a caller ignoring a "call this once" contract rather than a lifetime bug, so prefer the child: multiple locks is CWE-764, multiple unlocks CWE-765, multiple releases of a handle CWE-1341, a duplicated `free()` CWE-415, multiple binds to one port CWE-605, and double decoding of the same data CWE-174.
