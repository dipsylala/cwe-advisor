...
The pre-Android-12 default exports a component as soon as it gains an intent filter, so the defect is usually an omitted `android:exported` rather than one deliberately set to `true`.
