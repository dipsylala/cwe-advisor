...
# SAFE: parse literal values instead of evaluating code
value = ast.literal_eval(user_supplied_text)

# SAFE: parse structured data instead of unpickling
data = json.loads(user_supplied_text)

# SAFE: process execution with an argument list, no shell
